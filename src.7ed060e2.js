...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"../src/constants/api.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.IMG_STANDARD_XLARGE = exports.URL_COMICS = exports.API_KEY = void 0;
// https://developer.marvel.com/docs
var API_KEY = 'a5837db97d72016c81a7a776f4240db9';
exports.API_KEY = API_KEY;
var API_URL = 'https://gateway.marvel.com/v1/public/';
var URL_COMICS = API_URL + 'comics';
exports.URL_COMICS = URL_COMICS;
var IMG_STANDARD_XLARGE = '/standard_xlarge';
exports.IMG_STANDARD_XLARGE = IMG_STANDARD_XLARGE;
},{}],"../src/utils/getDataApi.js":[function(require,module,exports) {
"use strict";
...
var GetDataApi = /*#__PURE__*/function () {
  function GetDataApi() {
    _classCallCheck(this, GetDataApi);
  }

  _createClass(GetDataApi, [{
    key: "getData",
    value: function () {
      var _getData = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(url) {
        var response;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                return _context.abrupt("return", response.data.data.results);
...
},{"./bundle-url":"../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"../src/components/Characters/Characters.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../src/components/Characters/img/close-white.svg":[function(require,module,exports) {
module.exports = "/close-white.54c362ca.svg";
},{}],"../src/components/Characters/img/close-black.svg":[function(require,module,exports) {
module.exports = "/close-black.c3358bac.svg";
},{}],"../src/components/Characters/Characters.js":[function(require,module,exports) {
"use strict";
  ...
  _createClass(Characters, [{
    ...
    value: function renderContent(data) {
      ...
      data.forEach(function (_ref) {
        ...
        var imgSrc = path + _api.IMG_STANDARD_XLARGE + "." + extension;
        htmlContent += "\n                <li class=\"characters__item\">\n                    <img class=\"img-cover characters__image\" src=\"".concat(imgSrc, "\" />\n                    <span class=\"characters__name\">").concat(name, "</span>\n                </li>\n            ");
      });
...
},{"../../utils/getDataApi":"../src/utils/getDataApi.js","../../constants/api":"../src/constants/api.js","../../constants/root":"../src/constants/root.js","./Characters.css":"../src/components/Characters/Characters.css","./img/close-white.svg":"../src/components/Characters/img/close-white.svg","./img/close-black.svg":"../src/components/Characters/img/close-black.svg"}],"../src/components/Characters/index.js":[function(require,module,exports) {
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./Characters":"../src/components/Characters/Characters.js"}],"../src/components/Comics/Comics.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _getDataApi.getDataApi.getData(_api.URL_COMICS);
              ...
              case 2:
                ...
                data.forEach(function (_ref) {
                  var title = _ref.title,
                      ...
                      path = _ref$thumbnail.path,
                      extension = _ref$thumbnail.extension,
                      collectionURI = _ref.characters.collectionURI;

                  if (path.lastIndexOf('image_not_available') === -1) {
                    var imgSrc = path + _api.IMG_STANDARD_XLARGE + "." + extension;
                    htmlContent += "\n\t\t\t\t\t<li class=\"comics__item\" data-uri=\"".concat(collectionURI, "\">\n\t\t\t\t\t\t<span class=\"comics__name\">").concat(title, "</span>\n\t\t\t\t\t\t<img class=\"img-contain comics__image\" src=\"").concat(imgSrc, "\" />\n\t\t\t\t\t</li>\n\t\t\t\t");
                  }
                });
...
exports.default = _default;
},{"../../utils/getDataApi":"../src/utils/getDataApi.js","../../constants/api":"../src/constants/api.js","../../constants/root":"../src/constants/root.js","../Characters":"../src/components/Characters/index.js","./Comics.css":"../src/components/Comics/Comics.css"}],"../src/components/Comics/index.js":[function(require,module,exports) {
"use strict";
